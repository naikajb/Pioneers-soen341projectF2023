...
import { DialogContent, DialogTitle, DialogActions, TextField } from '@mui/material'

function Edit ({ data }) { // eslint-disable-line
  return (
    <Popup>
...
// Parent component
function ParentComponent () {// eslint-disable-line
